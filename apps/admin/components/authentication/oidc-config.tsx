...
export const OIDCConfiguration = observer(function OIDCConfiguration(props: Props) {
  ...
  const isOIDCEnabled = Boolean(parseInt(OIDCConfig));
  // Display name and scopes both have defaults, so only the three values that
  // cannot be guessed count towards "configured".
