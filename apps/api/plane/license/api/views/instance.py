...
class InstanceEndpoint(BaseAPIView):
    ...
    def get(self, request):
        ...
        (
            ...
            [
                ...
                },
                {
                    ...
                    "default": os.environ.get("OIDC_DISPLAY_NAME", "Single sign-on"),
                },
        ...
        # Label for the sign-in button; the generic provider has no brand name
        # of its own, so the operator supplies one.
        data["oidc_display_name"] = str(OIDC_DISPLAY_NAME or "Single sign-on")
